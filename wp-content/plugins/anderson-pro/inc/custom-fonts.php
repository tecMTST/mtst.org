...
add_action( 'wp_enqueue_scripts', 'anderson_pro_load_google_fonts', 1 );
add_action( 'enqueue_block_editor_assets', 'anderson_pro_load_google_fonts', 1 );

function anderson_pro_load_google_fonts() {

	// Get Theme Options from Database.
	$theme_options = anderson_pro_theme_options();

	// Get Local Fonts which haven't to be load from Google.
	$local_fonts = anderson_pro_get_local_fonts();
	...
	wp_enqueue_style( 'anderson-pro-custom-fonts', $google_fonts_url, array(), null );
}
 ...
 */
function anderson_pro_get_font_family( $font ) {
...
add_action('wp_head', 'anderson_pro_css_fonts');

function anderson_pro_css_fonts() {
	...
	if ( isset($theme_options['text_font']) and $theme_options['text_font'] <> 'Carme' ) :
		...
		$font_css .= '
			body, input, textarea, #mainnav-menu ul a {
				font-family: ' . anderson_pro_get_font_family( $theme_options['text_font'] ) . ';
			}';
	...
	if ( isset($theme_options['title_font']) and $theme_options['title_font'] <> 'Share' ) :
		...
		$font_css .= '
			...
			#comments .comments-title, #respond #reply-title {
				font-family: ' . anderson_pro_get_font_family( $theme_options['title_font'] ) . ';
			}';
	...
	if ( isset($theme_options['navi_font']) and $theme_options['navi_font'] <> 'Share' ) :
		...
		$font_css .= '
			#mainnav-icon, #mainnav-toggle, #mainnav-menu a {
				font-family: ' . anderson_pro_get_font_family( $theme_options['navi_font'] ) . ';
			}';
	...
	if ( isset($theme_options['widget_title_font']) and $theme_options['widget_title_font'] <> 'Share' ) :
		...
		$font_css .= '
			.widgettitle span {
				font-family: ' . anderson_pro_get_font_family( $theme_options['widget_title_font'] ) . ';
			}';
 ...
 * @return void
 */
function anderson_pro_editor_fonts_css() {
	$custom_css = '';
	...
	// Add Custom CSS.
	if ( '' !== $custom_css ) {
		wp_add_inline_style( 'anderson-editor-styles', $custom_css );
	}
}
add_action( 'enqueue_block_editor_assets', 'anderson_pro_editor_fonts_css' );
 ...
 */
function anderson_pro_get_local_fonts() {
 ...
 */
function anderson_pro_get_google_fonts() {
