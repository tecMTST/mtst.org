...
const HSTS_PLUGIN_VERSION = '5.0.23';
...
<div class="wrap HeaderSecurityAdvancedHSTSWPROSHUEbkgpadw">
    ...
    <div class="HeaderSecurityAdvancedHSTSWPROSHUEgridgap1546">
        ...
        <div class="HeaderSecurityAdvancedHSTSWPROSHUEtxgrh1">
            ...
            <table border="0px">
                <tr>
                    <td><a href="https://www.buymeacoffee.com/tentacleplugins" target="_blank"><img src="<?php echo esc_url( plugins_url( 'headers-security-advanced-hsts-wp/assets/images/orange-button-min.png' ) ); ?>" style="max-width: 90%;" alt="<?php esc_attr_e( 'Buy me a coffee', 'headers-security-advanced-hsts-wp' ); ?>" /></a></td>
                    <td><a href="https://www.paypal.com/donate/?hosted_button_id=M72GQUM8CWTZS" target="_blank"><img src="<?php echo esc_url( plugins_url( 'headers-security-advanced-hsts-wp/assets/images/cyan-button-min.png' ) ); ?>" style="max-width: 90%;" alt="<?php esc_attr_e( 'Donate via PayPal', 'headers-security-advanced-hsts-wp' ); ?>" /></a></td>
                </tr>
...
function hsts_plugin_add_dashboard_widget(): void {
    wp_add_dashboard_widget(
        ...
        '<img style="max-width:30px;" src="' . esc_url( plugins_url( 'headers-security-advanced-hsts-wp/assets/images/icon-headers-security-advanced-hsts.svg' ) ) . '" />' . esc_html__( 'Headers Security Advanced & HSTS WP', 'headers-security-advanced-hsts-wp' ),
...
function hsts_plugin_get_dashboard_widget_contents(): void {
    ?>
        ...
        <table border="0px">
            <tr>
                <td>
                    <a href="https://www.buymeacoffee.com/tentacleplugins" target="_blank">
                        <img src="<?php echo esc_url( plugins_url( 'headers-security-advanced-hsts-wp/assets/images/orange-button-min.png' ) ); ?>" style="max-width: 90%;" alt="<?php esc_attr_e( 'Buy me a coffee', 'headers-security-advanced-hsts-wp' ); ?>" />
                    </a>
                </td>
                <td>
                    <a href="https://www.paypal.com/donate/?hosted_button_id=M72GQUM8CWTZS" target="_blank">
                        <img src="<?php echo esc_url( plugins_url( 'headers-security-advanced-hsts-wp/assets/images/cyan-button-min.png' ) ); ?>" style="max-width: 90%;" alt="<?php esc_attr_e( 'Donate via PayPal', 'headers-security-advanced-hsts-wp' ); ?>" />
                    </a>
                </td>
            </tr>
        </table>
