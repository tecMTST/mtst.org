 ...
 */
if ( ! class_exists( 'CBXPetition_Settings' ) ):

	class CBXPetition_Settings {
		...
		function callback_file_extensions_checker( $args ) {
			...
			$image_ext_arr = CBXPetitionHelper::imageExtArr(); //todo:
		...
		function show_forms() {
            ...
            <div class="metabox-holder">
				<?php foreach ( $this->settings_sections as $form ) { ?>
                    <div id="<?php echo $form['id']; ?>" class="cbxpetition_group" style="display: none;">
                        <form method="post" action="options.php">
							<?php
							do_action( 'cbxpetition_form_top_' . $form['id'], $form );
							settings_fields( $form['id'] );
							do_settings_sections( $form['id'] );
							do_action( 'cbxpetition_form_bottom_' . $form['id'], $form );
							?>
