...
class CBXPetitionBlueimpFileUploadHandler {
	...
	protected function get_file_name(
		...
		$name = $this->trim_file_name( $file_path,
			$name,
			$size,
			$type,
			$error,
		...
		return $this->get_unique_filename(
			$file_path,
			$this->fix_file_extension( $file_path,
				$name,
				$size,
				$type,
				$error,
	...
	protected function gd_get_image_object( $file_path, $func, $no_cache = false ) {
		if ( empty( $this->image_objects[ $file_path ] ) || $no_cache ) {
			...
			$this->image_objects[ $file_path ] = $func( $file_path );  //possible fatal error
		}
...
}//end class CBXPetitionBlueimpFileUploadHandler