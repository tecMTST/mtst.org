...
function accordions_main_style($atts)
{
    ...
    ?><style type='text/css'>
        ...
        <?php
        if ($lazy_load == 'yes') {
        ?><?php echo esc_attr('#accordions-' . $post_id); ?> .items {
            display: none;
        }
        ...
        ?><?php echo esc_attr('#accordions-' . $post_id); ?> <?php echo esc_attr('#header-' . $index); ?> {
