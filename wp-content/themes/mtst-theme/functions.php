...
// Função para criar shortcode de incorporação do post do Instagram com legenda
function embed_instagram_post($atts) {
  // Extrai os atributos passados para o shortcode
  $atts = shortcode_atts(
      array(
  ...
  // Verifica se a URL do post do Instagram foi passada
  if (empty($atts['url'])) {
